...
public class Calculator implements ActionListener{
  ...
  Calculator(){
    ...
    textfield1.setBounds(50, 0, 300, 50);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    for(int i=0;i<10;i++) {
      ...
      if(e.getSource() == numberButtons[i]) {
        ...
        tempfield.setText(tempfield.getText().concat(String.valueOf(i)));
    ...
    if(e.getSource()==decButton) {
      ...
      tempfield.setText(tempfield.getText().concat("."));
    ...
    if(e.getSource()==addButton) {
      ...
      tempfield.setText("");
        ...
        textfield1.setText("Error... Please press Clear to try again");
      }
    }
    ...
    if(e.getSource()==equButton) {
      ...
      num2=Double.parseDouble(tempfield.getText());
